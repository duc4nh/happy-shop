module ApiHelpers
  ...
  # def verify_captcha
  #   raise Gpolis::Exceptions::InvalidCaptcha unless Captcha.verify(request.ip, params[:captcha])
  # end
  ...
  # def update_social_contacts(contacts)
  #   contacts.each do |c|
  #     contact = SocialContact.find(c[:id])
  #     contact.update(social_name: c[:social_name], social_id: c[:social_id])
  #   end
  # end
